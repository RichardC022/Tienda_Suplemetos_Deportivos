...
autonumber
    ...
    opt Visualizar Carrito
        Cliente->>InterfazCompra: verCarrito
        InterfazCompra->>ControlCompra: visualizarCarrito
        ControlCompra->>EntidadCompra: obtenerCarrito
        EntidadCompra-->>ControlCompra: carrito
        ControlCompra-->>InterfazCompra: mostrarProductos/Total
    end

    opt Eliminar producto
        Cliente->>InterfazCompra: eliminarProducto
        InterfazCompra->>ControlCompra: eliminarProducto
        ControlCompra->>EntidadCompra: eliminarDelCarrito
        EntidadCompra-->>ControlCompra: carritoActualizado
        ControlCompra-->>InterfazCompra: actualizarCarrito
    end
    ...
    Cliente->>ControlCompra: validarDatosPersonales
